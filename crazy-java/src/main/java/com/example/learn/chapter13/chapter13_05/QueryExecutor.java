package com.example.learn.chapter13.chapter13_05;
...
import java.sql.*;
/**
 * Description:使用ResultSetMetaData分析结果集
...
public class QueryExecutor
{
	...
	static
	{
		try
		{
			...
			props.load(new FileInputStream("resource\\chapter13_04_执行SQL语句的方式\\mysql.ini"));

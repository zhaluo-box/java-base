package com.example.learn.chapter13.chapter13_06;
...
public class JdbcRowSetTest {
    ...
    public void update(String sql) throws Exception {
        ...
        try (
                        ...
                        // 创建JdbcRowSetImpl对象
                        JdbcRowSet jdbcRs = new JdbcRowSetImpl(conn))   // ①与内部API绑定不好，再java7中更改Factory
    ...
    public static void main(String[] args) throws Exception {
        ...
        jt.initParam("resource\\chapter13_04_执行SQL语句的方式\\mysql.ini");

...
public class ObjectPoolFactory {
    ...
    // 定义一个创建对象的方法，
    // 该方法只要传入一个字符串类名，程序可以根据该类名生成Java对象 xml ref引入的对象或者prope引入的对象
    ...
    public static void main(String[] args)
        ...
        pf.initPool("C:\\githubspace\\crazyjava\\src\\main\\java\\com\\zhaluobox\\crazyjava\\chapter18\\section04\\obj.txt");

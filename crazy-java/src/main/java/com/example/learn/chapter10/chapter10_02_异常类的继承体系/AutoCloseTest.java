 ...
 */
public class AutoCloseTest implements Serializable {
    ...
    public static void main(String[] args) throws IOException {
        try (
                        ...
                        BufferedReader br = new BufferedReader(
                                        new FileReader("第10章异常处理\\chapter10_02_异常类的继承体系\\A0utoCloseTest.java")); PrintStream ps = new PrintStream(
                        new FileOutputStream("第10章异常处理\\chapter10_02_异常类的继承体系\\a.txt"))) {
            // 使用两个资源

...
/**
 * POI API 过于复杂，暂时不做调研学习
 * Created  on 2022/5/24 11:11:08
 *
 * @author zl
 */
@Slf4j
public class XWPFDocTest {
    //    private static String filePath = "D:\\tmp-dir\\水印测试.docx";
    //
    ...
    public static void main(String[] args) throws Exception {
        //        String filePath = "D:\\tmp-dir\\SVN使用操作手册V.0.1.docx";
        String filePath = "D:\\tmp-dir\\SD_201_客户主数据创建接口_技术说明_V1.0.docx";
    ...
    public static void addWaterMark(String filePath, String waterMarkValue) throws IOException, XmlException {
        ...
        xFooter.createWatermark("123-skh-20220423-1");
        ...
        //                String newText = paraText.replace("</xml-fragment>", waterMarkValue);
        ...
        OutputStream out = new FileOutputStream(afterPath);
        document.write(out);
        out.flush();
        try {
            in.close();
    ...
    public static void replaceWaterMark(XWPFParagraph graph, String waterMarkValue) throws IOException, XmlException {
        ...
        if (paraText.contains("id=\"PowerPlusWaterMarkObject")) {//<v:shape id=\"PowerPlusWaterMarkObject
            ...
            String newText = paraText.replace("string=\"" + oldWaterMarkText + "\"", "string=\"" + waterMarkValue + "\"");
            XmlToken token = XmlToken.Factory.parse(newText);
            graph.getCTP().set(token);
        }
    }
